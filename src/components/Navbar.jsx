    ...
    <>
      <div className='gap-4 absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent gap-4'>
          ...
          <ul className="hidden md:flex gap-2 text-black bg-white shadow-md px-8 py-3 rounded-full fixed top-5 left-1/2 transform -translate-x-1/2">
            <NavLink 
              to="/profile" 
          ...
          <button className='hidden md:block bg-red-500 text-white px-8 py-2 rounded-full hover:bg-red-600 transition-all' onClick={goToSignup}>
            Signup
          </button>
